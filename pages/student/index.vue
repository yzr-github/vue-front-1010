    ...
    <div id="aCoursesList" class="bg-fa of">
        ...
        <section class="container">
            <header class="comm-title all-teacher-title">
                <h2 class="fl tac">
                    <span class="c-333">在线学生</span>
                </h2>
                <section class="c-tab-title">
                    <a id="subjectAll" title="全部" href="#">18软件2班</a>
                ...
                <ul class="of">
                    ...
                    <section class="i-teach-wrap">
                        ...
                        <div class="mt10 hLh30 txtOf tac">
                            <a href="/teacher/1" title="姚晨" target="_blank"
                            class="fsize18 c-666">刘龙</a>
                        </div>
                        <div class="hLh30 txtOf tac">
                            <span class="fsize14 c-999">201830625226</span>
                        </div>
                        <!-- <div class="mt15 i-q-txt">
                            <p class="c-999 f-fA">201830625226</p>
                        </div> -->
                    </section>
                    </li>
                    <li>
